...
# userAuth = firebase.auth().get_account_info(idToken)

# secret = "2eaxfxkaGKxR1VVnY9ipBkOSGarvQD3y" #secret key
# payload = {"uid": userAuth['users'][0]['localId']}
# token = jwt.encode(payload, secret, algorithm="HS256", headers={
